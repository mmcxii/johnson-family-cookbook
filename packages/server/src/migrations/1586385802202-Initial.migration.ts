...
export class Initial1586385802202 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "gender_code_enum" AS ENUM('1', '2', '3')`,
      undefined,
    );
    await queryRunner.query(
      `CREATE TABLE "gender" ("id" SERIAL NOT NULL, "external_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "archived_at" TIMESTAMP, "name" "gender_name_enum" NOT NULL, "code" "gender_code_enum" NOT NULL, CONSTRAINT "UQ_715cef762c43bdc30e83bea1615" UNIQUE ("name"), CONSTRAINT "UQ_fd1bd0a76c4fa6e65774159c99b" UNIQUE ("code"), CONSTRAINT "PK_98a711129bc073e6312d08364e8" PRIMARY KEY ("id"))`,
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user" ADD CONSTRAINT "FK_6d4390ab1c0e8c86287d9f4c430" FOREIGN KEY ("gender_id") REFERENCES "gender"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
      undefined,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP TYPE "permission_level_code_enum"`,
      undefined,
    );
    await queryRunner.query(
      `DROP TYPE "permission_level_name_enum"`,
      undefined,
    );
