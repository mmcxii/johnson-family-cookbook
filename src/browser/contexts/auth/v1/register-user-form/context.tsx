...
import {
  GetApiAuthV1RegisterUserSchemaResponse,
  PostApiAuthV1RegisterUserParams,
  getApiAuthV1RegisterUserSchema,
...
export type ContextData = {
  data: {
    schema: null | GetApiAuthV1RegisterUserSchemaResponse;
  };
  error: {
    get: null | string;
    post: null | string;
  ...
  get: () => Promise<void>;
  post: (params: PostApiAuthV1RegisterUserParams) => Promise<void>;
};
...
export const ApiProvider: React.FC<ApiProviderProps> = (props) => {
  ...
  const get: ContextData["get"] = async () => {
    ...
    try {
      const data = await getApiAuthV1RegisterUserSchema();
